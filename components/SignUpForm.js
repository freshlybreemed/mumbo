  ...
  async getSongs() {
    await axios
      ...
      .then(songs => {
        ...
        var availableSongs = karaokeSongs.filter(
          song => typeof song.email === 'undefined',
        );
        this.setState({
      ...
      <div>
        <div class="about">
          <form class="rsvp-form">
            ...
            <br></br>
            <div class="rsvp-form">
              <label htmlFor="name">Select your song </label>
              <br></br>
              <select
            ...
            <button
              ...
              class="btn btn--right btn--tickets"
            >
              SIGN UP
            </button>
          </form>
