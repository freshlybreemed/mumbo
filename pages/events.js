      ...
      <div class="events-wrapper">
        <div class="media">
          <div
            class="asset-mumbo"
            style={{
              backgroundImage: 'url(' + 'static/img/rumble/IMG_6904.png)',
            }}
          ></div>
          <div class="content">
            ...
            <p class="event-list__item__text--support">
              Hav Mercy, Spinrillo, Kory J Campbell & more
            </p>
            ...
            <p>
              Doors @ 9:00pm
              <meta itemprop="doorTime" content="10:00PM" /> | Free
            </p>
            <p>
              <meta itemprop="location" content="The 9:30 Club" />
              Cloak & Dagger, Washington, DC
              <meta itemprop="addressLocality" content="Silver Spring, MD" />
            </p>
            {/* <a
              href="https://www.ticketfly.com/purchase/event/1868235"
              title="Tickets for Chicken & Mumbo Sauce"
              target="_blank"
            >
